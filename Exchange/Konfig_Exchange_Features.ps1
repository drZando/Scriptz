...
##########################################################################################################
# Release Notes:
# V1.0 - 09.11.2015: Initialer Release
##########################################################################################################
...
$aui_XC2010_und_hoecher_MB = get-mailbox -Server $MailboxServer | Get-CASMailbox | Where-Object {$_.ExchangeVersion.ExchangeBuild.Major -ge 14}
